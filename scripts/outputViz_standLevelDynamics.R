...
simName <- c("ForMont_2022-08-09")
a <- "ForMont"
s <- gsub(paste0(a, "_"),"", simName)
...
###################################################################
## fetching output
biomass <- get(load(paste0("../outputCompiled/standDynamics_", a, "_biomass_",
                       s, ".RData")))
fluxes <- get(load(paste0("../outputCompiled/standDynamics_", a, "_fluxes_",
                          s, ".RData")))
harv <- get(load(paste0("../outputCompiled/standDynamics_", a, "_harvestLog_",
                           s, ".RData")))
DOM <- get(load(paste0("../outputCompiled/standDynamics_", a, "_DOM_",
                        s, ".RData")))
nSims <- length(unique(biomass$replicate))
